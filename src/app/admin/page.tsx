...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    if (!session || session.user?.role !== "admin") {
      router.replace("/unauthorized"); // replace ile geri dönüş engellenir
    } else {
      setAuthorized(true);
    }
...
return (
  <main className="min-h-screen flex flex-col items-center justify-center gap-6 bg-gradient-to-br from-blue-400 to-indigo-600 text-white p-4">
